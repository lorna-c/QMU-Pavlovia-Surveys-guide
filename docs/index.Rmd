...
Please be aware that if you are using logics with more than one item (e.g. you make a question Visible If Q1 = 2 **and** Q3 = 4), this will not work in the later versions - in these cases you should use version 2024.1.0.
I will update this section if this changes.
